...
public class ItemManager : MonoBehaviour
{
    ...
    {
        //random index
        item_index = Random.Range(0, item_gameobjects.Length);//item_gameobjects.Length);
    ...
    IEnumerator UseBullet()
    {
        ...
        player_script.ambient_particles.SetActive(false);
        ...
        player_script.ambient_particles.SetActive(true);
